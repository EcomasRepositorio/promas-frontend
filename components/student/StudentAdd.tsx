    ...
    try {
      ...
      if (
        ...
        setError("code", {
          type: "manual",
          message:
            "El codigo debe contener solo números y exactamente 8 o 9 digitos",
        });
        return;
      }
      // if (!Num(data.hour)) {
          ...
          <div className="flex justify-between col-span-2 whitespace-pre-wrap">
            <div className="mb-4">
              ...
              <input
                ...
                className={`border rounded-lg p-1 lg:w-36 w-24 ${
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className={`border rounded-lg p-1 lg:w-32 w-28 ${
          ...
          <div className="flex justify-between col-span-2 whitespace-pre-wrap">
            <div className="mb-4">
              ...
              <input
                ...
                className={`border rounded-lg p-1 lg:w-36 w-36 ${
            ...
            <div className="mb-4 lg:ml-3">
              ...
              <input
                ...
                className="border rounded-lg p-1 lg:w-44 w-36"
              />
            </div>
          </div>
