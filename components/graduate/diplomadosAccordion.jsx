...
import Link from "next/link"; // Importamos Link para manejar los enlaces correctamente
...
const Curso = ({ curso }) => {
  ...
  // Definimos la función toRoman en este archivo
  ...
  // Corregimos la función para generar el enlace de WhatsApp correctamente
  const generarEnlaceWhatsapp = (cursoTitulo, modulo) => {
    ...
    const url = `https://api.whatsapp.com/send?phone=51984040264&text=${encodeURIComponent(
      mensaje
    )}&app_absent=0`;
    return url;
  };
      ...
      <div className="container mx-auto">
        <div className="flex flex-wrap">
          ...
          <div className="lg:w-1/2 lg:pl-10 lg:py-6 mb-6 lg:mb-0">
            <h2 className="text-sm title-font text-gray-500 dark:text-black tracking-widest mt-4 sm:mt-2 md:mt-2 lg:mt-0">
              {curso.area}
            </h2>
            <h1 className="text-primaryblue text-3xl title-font font-medium mb-4">
              {curso.titulo}
            </h1>
            <Accordion defaultExpandedKeys={["1"]}>
              <AccordionItem
                ...
                title={
                  <h2 className="text-blackblue dark:text-black">
              ...
              >
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center mb-2">
                    <Image
                      ...
                      priority={true}
                    />
                    <p className="font-bold ml-1">Inscripciones abiertas</p>
                  </div>
                  <div className="flex items-center mb-2">
                    <Image
                      src="/MODALIDAD.png"
                ...
                {/* Ajustamos el espaciado y alineación en móviles */}
              ...
              >
                <ul className="space-y-4">
                  {curso.modulos.map((modulo, moduloIndex) => (
                    <li
                      key={moduloIndex}
                      className="flex items-center justify-between border-2 border-violet-500 rounded-lg py-2 px-4 text-gray-800"
                    >
                      <Link
