        ...
        <div className="container mx-auto px-10">
          <div className="flex items-center justify-center lg:justify-between">
            ...
            <div className="flex justify-center">
              <a href="#!" className="mr-6 text-gray-100 dark:text-gray-200 hover:scale-150 border rounded-full p-2">
                <svg
              ...
              <a href="#!" className="text-gray-100 dark:text-gray-200 hover:scale-150 border rounded-full p-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6"
                  fill="currentColor"
